    ...
    <div v-if="currentView === 'shop'">
      ...
      <div class="text-center mb-5">
        ...
        <p class="lead text-muted">
          ...
          <b>NOTE THAT PRE-ORDERS HAVE OFFICIALLY CLOSED</b><br/>
          However due to extremely high demand, we will be extending orders!🎉<br />
          <i>Kindly note that collections may be after 12 February</i><br />
          <i>Walk-in sales (except for CD Keychains) for will be available at the same location and time, while stocks last!</i><br />
